...
def apply_custom_config():
    ...
    custom_conf_path = os.path.join(current_dir, "src", "mcp_postgres_duwenji", "assets", "postgresql.conf")
    ...
    try:
        result = subprocess.run(
            ["docker", "ps", "--filter", "name=mcp-postgres-auto", "--format", "{{.Names}}"],
